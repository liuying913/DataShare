            ...
            <div class="base-info baseInfo ">
                <div class="base-info-input">
                    <ul class="clearfix" style="margin: 10px 0 0 113px;">
                    	<li>
                        	<span>台站编号</span>
                            <label><input name="userName" type="text" value="" class="input01" disabled="disabled"></label>
                        </li>
                        <li>
                        	<span>台站名称</span>
                            <label><input name="userCName" type="text" value="" class="input01" disabled="disabled"></label>
                        </li>
                        <li>
                        ...
                        <li>
                         ...
                         <li>
                            <span>天线高(前)</span>
                            <label><input name="regDateStr" type="text" value="" class="input01"></label>
                        </li>
                        <li>
                            <span>天线高(后)</span>
                            <label><input name="userTypeStr" type="text" value="" class="input01"></label>
                        </li>
    ...
    <script>	
    	...
    	$(document).ready(function(){
			...
			ajaxRequest("/DataShare/greatEvent/typelList.action?id="+id,"get",function(res){
                ...
                $(".input01").eq(4).val(res[0].height_new);
                $(".input01").eq(5).val(res[0].height_old);
                
                $(".input01").eq(6).val(res[0].model_new);
                $(".input01").eq(7).val(res[0].model_old);
                $(".input01").eq(8).val(res[0].rinex_new);
                $(".input01").eq(9).val(res[0].rinex_old);
                
                $(".input01").eq(10).val(res[0].sn_new);
                $(".input01").eq(11).val(res[0].sn_old);
                $(".input01").eq(12).val(res[0].describe);
                $(".input01").eq(13).val(res[0].feedback);
			})
