...
public class STOR extends AbstractCommand {
    ...
    public void execute(final FtpIoSession session,
        ...
        try {
    		...
    		if(null!=user){
    			String ftpUserName = user.getName();
    			String ftpRelatviePath = MapAll.mapUserName.get(ftpUserName).getFtpRelativePath();
    			//ftpRelatviePath = ftpRelatviePath.replaceAll("\\", "@@@@@");
    			//ftpRelatviePath = ftpRelatviePath.replaceAll("@@@@@", "/");
    			//System.out.println(fileName+"    22   "+ftpRelatviePath);
    			if(!fileName.startsWith(ftpRelatviePath)){
        			System.out.println("没有上传权限！");
                	return;
	    		}else{
	    			System.out.println("具备上传权限！");
	    		}
    		}
    		//******2017-04-19 22:11******************************************************
            // get permission
