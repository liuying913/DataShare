				   ...
				   <div class="base-info  baseInfo">
					   <div class="base-info-input">
						   <ul id="userInfo">
							   ...
							   <li>
								   <span>注册日期 ：</span>
								   <label><input name="regDateStr" type="text" value="" class="input01 require" err="请填写联系电话" disabled="disabled"></label>
							   </li>
							   <li>
								   <span>是否管理员 ：</span>
								   <label>
										<input type="hidden" name="userTypeStr" class="input01" id="arrangement" value="是">
						   ...
						   <form action="/DataShare/updateUserInfo.action" method="get" >
							   <div class="base-info-input">
								   <ul  style="margin-left:270px;">
									   <li>
										   <span><b class="requireFlag">*</b>原密码 ：</span>
										   <label><input id="oldUserPwd" name="oldUserPwd" type="password" value="" class="input01 require" err="请填写原密码"  style="-webkit-box-shadow: 0 0 0px 1000px white inset !important;"></label>
										   <div  class="sucuState"  style="display:none;"><p class="tishi" style="text-indent: 0px;"><img src="/DataShare/img/pcgzs/success.png"></p></div>
										   <div id="result_Name" class="errState" style="display:none;"><p class="tishi" style="color: #f73e4c"><img src="/DataShare/img/pcgzs/error.png">请填写原密码</p></div>
									   </li>
									   <li>
    	...
    	$(document).ready(function(){
			...
			$("#savePwd").click(function(){
				...
				$(".pwdChange .require").each(function(e){
					if($(this).val()==""){
						...
						if(e==rlenPwd-1&&i==0 && flag_1 && flag_2 && flag_3 && flag_4){
								...
								if(a==lenPwd-1){
									...
									ajaxRequest(URL,"get",function(res){
										...
										/*	CheckPassWord();*/
											...
											//var nextUrl="/DataShare/querUserSelfToJsp.action?applyTitle=个人信息";
	                                        ...
	                                        $(".confirm",window.parent.document).click( function(){
	 											window.location.href="/DataShare/querUserSelfToJsp.action?applyTitle=个人信息";
	 		                                })
										}else{
			...
			//校验密码
	   		$("#oldUserPwd").blur(function(){
	             var type_new = $("#oldUserPwd").val();
	             var checkObj = $("#oldUserPwd").parent();
					   ...
					   $(this).parent().parent("li").find(".sucuState").hide();
						...
						if(e==rlen-1&&j==0){
							$("#userInfo .input01").each(function(a) {
								...
								if(a==len-1){
									var URL="/DataShare/updateUserInfo.action?uOp=upd&userId="+userId+"&"+strInfo;
									URL=encodeURI(URL);
									ajaxRequest(URL,"get",function(res){
										if(res.date[0].code==1){
