...
<body>
    ...
    <div class="CenterP-main">
       ...
       <div class="leftbar_top"><h3>共享指南</h3></div>
        <!--左侧弹性竖菜单-->
        <div id="menu">
	        <h1 onClick="javascript:ShowMenu(this,'NO2')" id="c_10"><a href="/DataShare/index.action?id=6" class="active">使用说明</a></h1>
	        <h1 onClick="javascript:ShowMenu(this,'NO2')" id="c_11"><a href="/DataShare/index.action?id=61">注意事项</a></h1>
