...
<body>
  ...
  <!--<div style="width:100%; height:10px;font-size:15px; color:#316bb5; margin:10px 20px 20px;line-height:0; font-weight:bold;">
	  <span class="icon1"></span> 申请流程
  </div>-->
  <div id="iframeheight">
			  <!--<div class="web-width">
				 <div class="for-liucheng" style="margin:10px auto">
					  ...
					  <div class="liutextbox">
						  ...
						  <div class="liutext for-cur"><em>5</em><br /><strong>数据下载</strong></div>
					  </div>
				  </div>
			  </div>-->
			                ...
			                <div class="base-info-input" style="width: 90%; margin: -10px auto 0px; padding: 20px 20px 0;  ">
						    	<div style="text-align:center; width:100%; height:15px;font-size:16px; color:#306ab5; margin-top:15px; line-height:0px; font-weight:bold;">
			                        ...
			                        <div style="text-align:center">
										<input type="checkbox" value="" checked disabled="disabled" id="ischeck"><b style="margin-left:10px;text-align:center;height:10px;font-size:14px; color:#316bb5; margin-top:0px; line-height:0px; font-weight:bold;">申请人阅读并遵守以上规定</b>
										<div class="warp-button">
											</br>
						                	<input type="button"  disabled="disabled"  id="next" class="shengfen-button selected" value="开始申请"><!--<img src="/DataShare/img/s1.png"/>-->
						                </div>
									</div>	
    ...
    <script>		
		...
		$("#next").click(function(){
    		...
    		window.location.href="/DataShare/applyOrShowToJsp.action?thisNum=0&backOrDown=down&isManager="+isManager+"&applyId="+applyId;
    	})
    </script>
