...
<%@ page import="com.highfd.common.map.MapAll"%>
<%@ page import="org.apache.commons.fileupload.*"%>
<%@ page import="org.apache.commons.fileupload.disk.*"%>
<%@ page import="org.apache.commons.fileupload.servlet.*"%>
<%@ page import="org.apache.commons.fileupload.util.*"%>
<%@ page import="com.alibaba.fastjson.*"%>
<%@ page import="com.jdbc.service.impl.AlarmJdbcServiceImpl"%>
<%@ page import="com.highfd.bean.UserInfo"%>
...
if ( contentType.indexOf("multipart/form-data") >= 0 ){
	...
	while( fileItems.hasNext() ){
		...
		//如果是原始图片 file 域的名称或者以默认的头像域名称的部分“__avatar”打头
			...
			String virtualPath = MapAll.configFile+"/head/jsp_avatar" + avatarNumber + "_" + fileName + ".jpg";
			...
			AlarmJdbcServiceImpl as = new AlarmJdbcServiceImpl();
			as.updateUserHead(userId,"jsp_avatar" + avatarNumber + "_" + fileName + ".jpg");
			inputStream = new BufferedInputStream(fileItem.openStream());
