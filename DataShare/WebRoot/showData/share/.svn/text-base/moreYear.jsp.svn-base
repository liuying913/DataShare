...
<head>
	...
	<script src="/DataShare/js/showData/shareYear.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
  ...
  <div id="iframeheight">
		...
		<div class="shop-warp02" style="display: block;">
			...
			<!--  ==表格==  -->
			<div class="warp02-bottom" style="width:100%"></div>
		</div>
		</div>
        </div>
        <style>
