...
public class TimeUtils {
	...
	public static void main(String[] args) {
		TimeUtils.getValidityTime("2017-12-31", 1);
	}
	...
	//判断两个时间差
	public static boolean ftpUpTimeFlag(Long ftpUpTime,int minuteNum){
		if(MapAll.ftpUpTime==0){
			return false;
		}
		long nowTime = System.currentTimeMillis();
    	if(nowTime-ftpUpTime>1000*60*minuteNum && nowTime-ftpUpTime<1000*60*minuteNum+20*1000){
    		return true;
    	}
		return false;
	}
